...
static const struct fg_iio_channels fg_iio_psy_channels[] = {
	...
	FG_CHAN_RES("esr_actual", PSY_IIO_ESR_ACTUAL)
	FG_CHAN_RES("esr_nominal", PSY_IIO_ESR_NOMINAL)
	FG_CHAN_INDEX("soh", PSY_IIO_SOH)
	FG_CHAN_INDEX("clear_soh", PSY_IIO_CLEAR_SOH)
	FG_CHAN_ENERGY("cc_soc", PSY_IIO_CC_SOC)
	FG_CHAN_VOLT("voltage_avg", PSY_IIO_VOLTAGE_AVG)
	FG_CHAN_CUR("current_avg", PSY_IIO_CURRENT_AVG)
	FG_CHAN_POW("power_avg", PSY_IIO_POWER_AVG)
	FG_CHAN_POW("power_now", PSY_IIO_POWER_NOW)
	FG_CHAN_ACT("scale_mode_en", PSY_IIO_SCALE_MODE_EN)
	FG_CHAN_INDEX("batt_age_level", PSY_IIO_BATT_AGE_LEVEL)
	FG_CHAN_ACT("cc_step", PSY_IIO_CC_STEP)
	FG_CHAN_ACT("cc_step_sel", PSY_IIO_CC_STEP_SEL)
	FG_CHAN_ACT("calibrate", PSY_IIO_CALIBRATE)
	...
	FG_CHAN_COUNT("cycle_counts", PSY_IIO_CYCLE_COUNTS)
	FG_CHAN_ENERGY("constant_charge_voltage", PSY_IIO_CONSTANT_CHARGE_VOLTAGE)
	FG_CHAN_VOLT("voltage_max", PSY_IIO_VOLTAGE_MAX)
