 ...
 */
#define pr_fmt(fmt)	"FG-GEN4: %s:%d " fmt, __func__, __LINE__
...
static struct fg_sram_param pm8150b_v1_sram_params[] = {
	FGPARAM(BATT_SOC, BATT_SOC_WORD, BATT_SOC_OFFSET, 4, 1, 1, 0, NULL,
		fg_decode_default),
	FGPARAM(FULL_SOC, FULL_SOC_WORD, FULL_SOC_OFFSET, 2, 1, 1, 0,
		fg_encode_default, fg_decode_default),
	FGPARAM(MONOTONIC_SOC, MONOTONIC_SOC_WORD, MONOTONIC_SOC_OFFSET, 2, 1, 1,
		0, NULL, fg_decode_default),
	FGPARAM(VOLTAGE_PRED, VOLTAGE_PRED_WORD, VOLTAGE_PRED_OFFSET, 2, 1000,
		244141, 0, NULL, fg_decode_voltage_15b),
	FGPARAM(OCV, OCV_WORD, OCV_OFFSET, 2, 1000, 244141, 0, NULL,
		fg_decode_voltage_15b),
	FGPARAM(VBAT_FINAL, VBAT_FINAL_WORD, VBAT_FINAL_OFFSET, 2, 1000, 244141,
		0, NULL, fg_decode_voltage_15b),
	FGPARAM(IBAT_FINAL, IBAT_FINAL_WORD, IBAT_FINAL_OFFSET, 2, 1000, 488282,
		0, NULL, fg_decode_current_16b),
	FGPARAM(RCONN, RCONN_WORD, RCONN_OFFSET, 2, 1000, 122070, 0,
		fg_encode_default, fg_decode_value_16b),
	FGPARAM(ESR, ESR_WORD, ESR_OFFSET, 2, 1000, 244141, 0, fg_encode_default,
		fg_decode_value_16b),
	FGPARAM(ESR_MDL, ESR_MDL_WORD, ESR_MDL_OFFSET, 2, 1000, 244141, 0,
		fg_encode_default, fg_decode_value_16b),
	FGPARAM(ESR_ACT, ESR_ACT_WORD, ESR_ACT_OFFSET, 2, 1000, 244141, 0,
		fg_encode_default, fg_decode_value_16b),
	FGPARAM(RSLOW, RSLOW_WORD, RSLOW_OFFSET, 2, 1000, 244141, 0, NULL,
		fg_decode_value_16b),
	FGPARAM(CC_SOC, CC_SOC_WORD, CC_SOC_OFFSET, 4, 1, 1, 0, NULL,
		fg_decode_cc_soc),
	FGPARAM(CC_SOC_SW, CC_SOC_SW_WORD, CC_SOC_SW_OFFSET, 4, 1, 1, 0, NULL,
		fg_decode_cc_soc),
	FGPARAM(ACT_BATT_CAP, ACT_BATT_CAP_WORD, ACT_BATT_CAP_OFFSET, 2,
		1, 1, 0, NULL, fg_decode_default),
	/* Entries below here are configurable during initialization */
	FGPARAM(CUTOFF_VOLT, CUTOFF_VOLT_WORD, CUTOFF_VOLT_OFFSET, 2, 1000000,
		244141, 0, fg_encode_voltage, NULL),
	FGPARAM(VBATT_LOW, VBATT_LOW_WORD, VBATT_LOW_OFFSET, 1, 1000,
		15625, -2000, fg_encode_voltage, NULL),
	FGPARAM(VBATT_FULL, VBATT_FULL_WORD, VBATT_FULL_OFFSET, 2, 1000,
		244141, 0, fg_encode_voltage, fg_decode_voltage_15b),
	FGPARAM(CUTOFF_CURR, CUTOFF_CURR_WORD, CUTOFF_CURR_OFFSET, 2,
		100000, 48828, 0, fg_encode_current, NULL),
	FGPARAM(SYS_TERM_CURR, SYS_TERM_CURR_WORD, SYS_TERM_CURR_OFFSET, 2,
		100000, 48828, 0, fg_encode_current, NULL),
	FGPARAM(DELTA_MSOC_THR, DELTA_MSOC_THR_WORD, DELTA_MSOC_THR_OFFSET,
		1, 2048, 1000, 0, fg_encode_default, NULL),
	FGPARAM(DELTA_BSOC_THR, DELTA_BSOC_THR_WORD, DELTA_BSOC_THR_OFFSET,
		1, 2048, 1000, 0, fg_encode_default, NULL),
	FGPARAM(ESR_TIMER_DISCHG_MAX, ESR_TIMER_DISCHG_MAX_WORD,
		ESR_TIMER_DISCHG_MAX_OFFSET, 1, 1, 1, 0, fg_encode_default,
		NULL),
	FGPARAM(ESR_TIMER_DISCHG_INIT, ESR_TIMER_DISCHG_INIT_WORD,
		ESR_TIMER_DISCHG_INIT_OFFSET, 1, 1, 1, 0, fg_encode_default,
		NULL),
	FGPARAM(ESR_TIMER_CHG_MAX, ESR_TIMER_CHG_MAX_WORD,
		ESR_TIMER_CHG_MAX_OFFSET, 1, 1, 1, 0, fg_encode_default, NULL),
	FGPARAM(ESR_TIMER_CHG_INIT, ESR_TIMER_CHG_INIT_WORD,
		ESR_TIMER_CHG_INIT_OFFSET, 1, 1, 1, 0, fg_encode_default, NULL),
	FGPARAM(ESR_PULSE_THRESH, ESR_PULSE_THRESH_WORD, ESR_PULSE_THRESH_OFFSET,
		1, 1000, 15625, 0, fg_encode_default, NULL),
	FGPARAM(DELTA_ESR_THR, DELTA_ESR_THR_WORD, DELTA_ESR_THR_OFFSET, 2, 1000,
		61036, 0, fg_encode_default, NULL),
	FGPARAM(KI_COEFF_CUTOFF, KI_COEFF_CUTOFF_WORD, KI_COEFF_CUTOFF_OFFSET,
		1, 1000, 61035, 0, fg_encode_default, NULL),
	FGPARAM(KI_COEFF_FULL_SOC, KI_COEFF_FULL_SOC_NORM_WORD,
		KI_COEFF_FULL_SOC_NORM_OFFSET, 1, 1000, 61035, 0,
		fg_encode_default, NULL),
	FGPARAM(KI_COEFF_LOW_DISCHG, KI_COEFF_LOW_DISCHG_WORD,
		KI_COEFF_LOW_DISCHG_OFFSET, 1, 1000, 61035, 0,
		fg_encode_default, NULL),
	FGPARAM(KI_COEFF_MED_DISCHG, KI_COEFF_MED_DISCHG_WORD,
		KI_COEFF_MED_DISCHG_OFFSET, 1, 1000, 61035, 0,
		fg_encode_default, NULL),
	FGPARAM(KI_COEFF_HI_DISCHG, KI_COEFF_HI_DISCHG_WORD,
		KI_COEFF_HI_DISCHG_OFFSET, 1, 1000, 61035, 0,
		fg_encode_default, NULL),
	FGPARAM(KI_COEFF_LOW_CHG, KI_COEFF_LOW_CHG_WORD, KI_COEFF_LOW_CHG_OFFSET,
		1, 1000, 61035, 0, fg_encode_default, NULL),
	FGPARAM(KI_COEFF_MED_CHG, KI_COEFF_MED_CHG_WORD, KI_COEFF_MED_CHG_OFFSET,
		1, 1000, 61035, 0, fg_encode_default, NULL),
	FGPARAM(KI_COEFF_HI_CHG, KI_COEFF_HI_CHG_WORD, KI_COEFF_HI_CHG_OFFSET, 1,
		1000, 61035, 0, fg_encode_default, NULL),
	FGPARAM(SLOPE_LIMIT, SLOPE_LIMIT_WORD, SLOPE_LIMIT_OFFSET, 1, 8192,
		1000000, 0, fg_encode_default, NULL),
	FGPARAM(BATT_TEMP_COLD, BATT_TEMP_CONFIG_WORD, BATT_TEMP_COLD_OFFSET, 1,
		1, 1, 0, fg_encode_default, NULL),
	FGPARAM(BATT_TEMP_HOT, BATT_TEMP_CONFIG_WORD, BATT_TEMP_HOT_OFFSET, 1,
		1, 1, 0, fg_encode_default, NULL),
	FGPARAM(ESR_CAL_SOC_MIN, BATT_TEMP_CONFIG2_WORD, ESR_CAL_SOC_MIN_OFFSET,
		1, 1, 1, 0, fg_encode_default, NULL),
	FGPARAM(ESR_CAL_SOC_MAX, ESR_CAL_THRESH_WORD, ESR_CAL_SOC_MAX_OFFSET,
		1, 1, 1, 0, fg_encode_default, NULL),
	FGPARAM(ESR_CAL_TEMP_MIN, ESR_CAL_THRESH_WORD, ESR_CAL_TEMP_MIN_OFFSET,
		1, 1, 1, 0, fg_encode_default, NULL),
	FGPARAM(ESR_CAL_TEMP_MAX, ESR_PULSE_THRESH_WORD, ESR_CAL_TEMP_MAX_OFFSET,
		1, 1, 1, 0, fg_encode_default, NULL),
};

static struct fg_sram_param pm8150b_v2_sram_params[] = {
	FGPARAM(VBAT_TAU, LOW_PASS_VBATT_WORD, LOW_PASS_VBATT_OFFSET, 1, 1, 1, 0,
		NULL, NULL),
	FGPARAM(BATT_SOC, BATT_SOC_v2_WORD, BATT_SOC_v2_OFFSET, 4, 1, 1, 0, NULL,
		fg_decode_default),
	FGPARAM(FULL_SOC, FULL_SOC_v2_WORD, FULL_SOC_v2_OFFSET, 2, 1, 1, 0,
		fg_encode_default, fg_decode_default),
	FGPARAM(MONOTONIC_SOC, MONOTONIC_SOC_v2_WORD, MONOTONIC_SOC_v2_OFFSET, 2,
		1, 1, 0, NULL, fg_decode_default),
	FGPARAM(VOLTAGE_PRED, VOLTAGE_PRED_v2_WORD, VOLTAGE_PRED_v2_OFFSET, 2,
		1000, 244141, 0, NULL, fg_decode_voltage_15b),
	FGPARAM(OCV, OCV_v2_WORD, OCV_v2_OFFSET, 2, 1000, 244141, 0, NULL,
		fg_decode_voltage_15b),
	FGPARAM(VBAT_FLT, VBAT_FLT_WORD, VBAT_FLT_OFFSET, 4, 10000, 19073, 0,
		NULL, fg_decode_voltage_24b),
	FGPARAM(VBAT_FINAL, VBAT_FINAL_WORD, VBAT_FINAL_OFFSET, 2, 1000, 244141,
		0, NULL, fg_decode_voltage_15b),
	FGPARAM(IBAT_FINAL, IBAT_FINAL_WORD, IBAT_FINAL_OFFSET, 2, 1000, 488282,
		0, NULL, fg_decode_current_16b),
	FGPARAM(IBAT_FLT, IBAT_FLT_WORD, IBAT_FLT_OFFSET, 4, 10000, 19073, 0,
	...
	FGPARAM(ESR_ACT, ESR_ACT_WORD, ESR_ACT_OFFSET, 2, 1000, 244141, 0,
		fg_encode_default, fg_decode_value_16b),
	FGPARAM(RSLOW, RSLOW_v2_WORD, RSLOW_v2_OFFSET, 2, 1000, 244141, 0, NULL,
		fg_decode_value_16b),
	FGPARAM(CC_SOC, CC_SOC_v2_WORD, CC_SOC_v2_OFFSET, 4, 1, 1, 0, NULL,
		fg_decode_cc_soc),
	FGPARAM(CC_SOC_SW, CC_SOC_SW_v2_WORD, CC_SOC_SW_v2_OFFSET, 4, 1, 1, 0,
		NULL, fg_decode_cc_soc),
	FGPARAM(ACT_BATT_CAP, ACT_BATT_CAP_v2_WORD, ACT_BATT_CAP_v2_OFFSET, 2,
		1, 1, 0, NULL, fg_decode_default),
	/* Entries below here are configurable during initialization */
	FGPARAM(CUTOFF_VOLT, CUTOFF_VOLT_WORD, CUTOFF_VOLT_OFFSET, 2, 1000000,
		244141, 0, fg_encode_voltage, NULL),
	...
	FGPARAM(KI_COEFF_HI_DISCHG, KI_COEFF_HI_DISCHG_WORD,
		KI_COEFF_HI_DISCHG_OFFSET, 1, 1000, 61035, 0,
		fg_encode_default, NULL),
	FGPARAM(KI_COEFF_LO_MED_DCHG_THR, KI_COEFF_LO_MED_DCHG_THR_WORD,
		KI_COEFF_LO_MED_DCHG_THR_OFFSET, 1, 1000, 15625, 0,
		fg_encode_default, NULL),
	FGPARAM(KI_COEFF_MED_HI_DCHG_THR, KI_COEFF_MED_HI_DCHG_THR_WORD,
	...
	FGPARAM(KI_COEFF_HI_CHG, KI_COEFF_HI_CHG_WORD, KI_COEFF_HI_CHG_OFFSET, 1,
		1000, 61035, 0, fg_encode_default, NULL),
	FGPARAM(KI_COEFF_LO_MED_CHG_THR, KI_COEFF_LO_MED_CHG_THR_WORD,
		KI_COEFF_LO_MED_CHG_THR_OFFSET, 1, 1000, 15625, 0,
		fg_encode_default, NULL),
	FGPARAM(KI_COEFF_MED_HI_CHG_THR, KI_COEFF_MED_HI_CHG_THR_WORD,
...
static int fg_gen4_read_range_data_from_node(struct device_node *node,
					...
					struct device_node *profile_node)
{
	...
	if (!of_property_read_bool(profile_node, "qcom,soc-based-step-chg") &&
		...
		rc = fg_gen4_read_range_data_from_node(profile_node,
...
static void get_batt_psy_props(struct fg_dev *fg)
{
	...
	rc = fg_read_iio_chan(fg, CHARGE_DONE, &val1); //POWER_SUPPLY_PROP_CHARGE_DONE
	if (rc < 0) {
	...
	if (!chip->recharge_soc_thr) {
		...
		rc = fg_read_iio_chan(fg, RECHARGE_SOC, &val1); //POWER_SUPPLY_PROP_RECHARGE_SOC
		if (rc < 0) {
...
static int fg_gen4_set_recharge_soc(struct fg_dev *fg, int recharge_soc)
{
	...
	rc = fg_write_iio_chan(fg, RECHARGE_SOC, recharge_soc); //POWER_SUPPLY_PROP_RECHARGE_SOC
	if (rc < 0) {
...
{
	struct fg_gen4_chip *chip = container_of(fg, struct fg_gen4_chip, fg);
	int rc = 0, msoc, bsoc, recharge_soc, msoc_raw, val1;
...
static int fg_gen4_esr_fcc_config(struct fg_gen4_chip *chip)
{
	...
	if (is_parallel_charger_available(fg)) {
		rc = fg_read_iio_chan(fg, PARALLEL_CHARGING_ENABLED, &val1); //POWER_SUPPLY_PROP_CHARGING_ENABLED
		if (rc < 0)
		...
		int *val2, long mask)
{
	...
	*val1 = 0;
	...
	switch (chan->channel) {
	case PSY_IIO_CAPACITY: //POWER_SUPPLY_PROP_CAPACITY
		rc = fg_gen4_get_prop_capacity(fg, val1);
		break;
	case PSY_IIO_REAL_CAPACITY: //POWER_SUPPLY_PROP_REAL_CAPACITY
		rc = fg_gen4_get_prop_real_capacity(fg, val1);
		break;
	case PSY_IIO_CAPACITY_RAW: //POWER_SUPPLY_PROP_CAPACITY_RAW
		rc = fg_gen4_get_prop_capacity_raw(chip, val1);
		break;
	case PSY_IIO_CC_SOC: //POWER_SUPPLY_PROP_CC_SOC
		rc = fg_get_sram_prop(fg, FG_SRAM_CC_SOC, &val);
		if (rc < 0) {
			pr_err("Error in getting CC_SOC, rc=%d\n", rc);
			return rc;
		}
		...
		*val1 = div_s64((int64_t)val * 10000,  CC_SOC_30BIT);
		break;
	case PSY_IIO_VOLTAGE_NOW: //POWER_SUPPLY_PROP_VOLTAGE_NOW
		if (fg->battery_missing)
			*val1 = 3700000;
		else
			rc = fg_get_battery_voltage(fg, val1);
		break;
	case PSY_IIO_CURRENT_NOW: //POWER_SUPPLY_PROP_CURRENT_NOW
		rc = fg_get_battery_current(fg, val1);
		break;
	case PSY_IIO_CURRENT_AVG: //POWER_SUPPLY_PROP_CURRENT_AVG
		rc = fg_get_sram_prop(fg, FG_SRAM_IBAT_FLT, val1);
		break;
	case PSY_IIO_TEMP: //POWER_SUPPLY_PROP_TEMP
		rc = fg_gen4_get_battery_temp(fg, val1);
		break;
	case PSY_IIO_RESISTANCE: //POWER_SUPPLY_PROP_RESISTANCE
		rc = fg_get_battery_resistance(fg, val1);
		break;
	case PSY_IIO_ESR_ACTUAL: //POWER_SUPPLY_PROP_ESR_ACTUAL
		*val1 = chip->esr_actual;
		break;
	case PSY_IIO_ESR_NOMINAL: //POWER_SUPPLY_PROP_ESR_NOMINAL
		*val1 = chip->esr_nominal;
		break;
	case PSY_IIO_VOLTAGE_OCV: //POWER_SUPPLY_PROP_VOLTAGE_OCV
		rc = fg_get_sram_prop(fg, FG_SRAM_OCV, val1);
		break;
	case PSY_IIO_VOLTAGE_AVG: //POWER_SUPPLY_PROP_VOLTAGE_AVG
		rc = fg_get_sram_prop(fg, FG_SRAM_VBAT_FLT, val1);
		break;
	case PSY_IIO_RESISTANCE_ID: //POWER_SUPPLY_PROP_RESISTANCE_ID
		*val1 = fg->batt_id_ohms;
		break;
	case PSY_IIO_VOLTAGE_MAX_DESIGN: //POWER_SUPPLY_PROP_VOLTAGE_MAX_DESIGN
	case PSY_IIO_VOLTAGE_MAX: //POWER_SUPPLY_PROP_VOLTAGE_MAX
		*val1 = fg->bp.float_volt_uv;
		break;
	case PSY_IIO_CHARGE_NOW_RAW: //POWER_SUPPLY_PROP_CHARGE_NOW_RAW
		rc = fg_gen4_get_charge_raw(chip, val1);
		break;
	case PSY_IIO_CHARGE_NOW: //POWER_SUPPLY_PROP_CHARGE_NOW
		*val1 = chip->cl->init_cap_uah;
		break;
	case PSY_IIO_CHARGE_FULL: //POWER_SUPPLY_PROP_CHARGE_FULL
		rc = fg_gen4_get_learned_capacity(chip, &temp);
		if (!rc)
			*val1 = (int)temp;
		break;
	case PSY_IIO_CHARGE_FULL_DESIGN: //POWER_SUPPLY_PROP_CHARGE_FULL_DESIGN
		rc = fg_gen4_get_nominal_capacity(chip, &temp);
		if (!rc)
			*val1 = (int)temp;
		break;
	case PSY_IIO_CHARGE_COUNTER: //POWER_SUPPLY_PROP_CHARGE_COUNTER
		rc = fg_gen4_get_charge_counter(chip, val1);
		break;
	case PSY_IIO_CHARGE_COUNTER_SHADOW: //POWER_SUPPLY_PROP_CHARGE_COUNTER_SHADOW
		rc = fg_gen4_get_charge_counter_shadow(chip, val1);
		break;
	case PSY_IIO_CYCLE_COUNT: //POWER_SUPPLY_PROP_CYCLE_COUNT
		rc = get_cycle_count(chip->counter, val1);
		break;
	case PSY_IIO_CYCLE_COUNTS: //POWER_SUPPLY_PROP_CYCLE_COUNTS
		*val1 = get_cycle_counts(chip->counter, NULL);
		break;
	case PSY_IIO_SOC_REPORTING_READY: //POWER_SUPPLY_PROP_SOC_REPORTING_READY
		*val1 = fg->soc_reporting_ready;
		break;
	case PSY_IIO_CLEAR_SOH: //POWER_SUPPLY_PROP_CLEAR_SOH
		*val1 = chip->first_profile_load;
		break;
	case PSY_IIO_SOH: //POWER_SUPPLY_PROP_SOH
		*val1 = chip->soh;
		break;
	case PSY_IIO_DEBUG_BATTERY: //POWER_SUPPLY_PROP_DEBUG_BATTERY
		*val1 = is_debug_batt_id(fg);
		break;
	case PSY_IIO_CONSTANT_CHARGE_VOLTAGE: //POWER_SUPPLY_PROP_CONSTANT_CHARGE_VOLTAGE
		rc = fg_get_sram_prop(fg, FG_SRAM_VBATT_FULL, val1);
		break;
	case PSY_IIO_TIME_TO_FULL_AVG: //POWER_SUPPLY_PROP_TIME_TO_FULL_AVG
	case PSY_IIO_TIME_TO_FULL_NOW: //POWER_SUPPLY_PROP_TIME_TO_FULL_NOW
		rc = ttf_get_time_to_full(chip->ttf, val1);
		break;
	case PSY_IIO_TIME_TO_EMPTY_AVG: //POWER_SUPPLY_PROP_TIME_TO_EMPTY_AVG
		rc = ttf_get_time_to_empty(chip->ttf, val1);
		break;
	case PSY_IIO_CC_STEP: //POWER_SUPPLY_PROP_CC_STEP
		...
		break;
	case PSY_IIO_CC_STEP_SEL: //POWER_SUPPLY_PROP_CC_STEP_SEL
		*val1 = chip->ttf->cc_step.sel;
		break;
	case PSY_IIO_BATT_AGE_LEVEL: //POWER_SUPPLY_PROP_BATT_AGE_LEVEL
		*val1 = chip->batt_age_level;
		break;
	case PSY_IIO_SCALE_MODE_EN: //POWER_SUPPLY_PROP_SCALE_MODE_EN
		*val1 = chip->soc_scale_mode;
		break;
	case PSY_IIO_POWER_NOW: //POWER_SUPPLY_PROP_POWER_NOW
		rc = fg_gen4_get_power(chip, val1, false);
		break;
	case PSY_IIO_POWER_AVG:
		rc = fg_gen4_get_power(chip, val1, true);
		break;
	case PSY_IIO_CALIBRATE: //POWER_SUPPLY_PROP_CALIBRATE
		...
		int val2, long mask)
{
	...
	case PSY_IIO_CLEAR_SOH: //POWER_SUPPLY_PROP_CLEAR_SOH
		if (chip->first_profile_load && !val1) {
			...
			val = 0;
			mask1 = FIRST_PROFILE_LOAD_BIT;
			rc = fg_sram_masked_write(fg, PROFILE_INTEGRITY_WORD,
					PROFILE_INTEGRITY_OFFSET, mask1, val,
					FG_IMA_DEFAULT);
			if (rc < 0)
...
static int fg_init_iio_psy(struct fg_gen4_chip *chip,
...
static int fg_gen4_probe(struct platform_device *pdev)
{
	...
	int rc = 0, msoc = 0, volt_uv = 0, batt_temp = 0;
	struct iio_dev *indio_dev;
