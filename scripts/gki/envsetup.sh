...
QCOM_VENDOR_DEBUG_FRAG=${CONFIGS_DIR}/${PLATFORM_NAME}_vendor_debug.config
QCOM_VENDOR_PERF_FRAG=${CONFIGS_DIR}/${PLATFORM_NAME}_vendor_perf.config
...
export ARCH CROSS_COMPILE REAL_CC HOSTCC HOSTLD HOSTAR KERN_SRC KERN_OUT \
	...
	QCOM_VENDOR_DEBUG_FRAG QCOM_VENDOR_PERF_FRAG
